...
for file in files:
    ...
    contents += ('   <div class=\"alert alert-error\"><br/><p><b>  NOTE: the latest version of this documentation can be found on <a href="https://docs.neuroml.org/Userdocs/Schemas/'+file+'.html">docs.neuroml.org</a>!</b></p><br/>For more information on NeuroML 2 and LEMS see <a href=\"http://www.neuroml.org/neuromlv2\">here</a>. <br/>Note: these descriptions have been updated to the latest '
            ...
            if dynamics.event_handlers is not None:
                ...
                for eh in dynamics.event_handlers:
                    if isinstance(eh, OnStart):
                        if len(os_content) == 0:
                            os_content += "<span class=\"label\">On Start</span><br/><br/>\n"
                    ...
                    if isinstance(eh, OnCondition):
                        if len(oc_content) == 0:
                            oc_content += "<span class=\"label\">On Conditions</span><br/><br/>\n"
                    ...
                    if isinstance(eh, OnEvent):
                        if len(oe_content) == 0:
                            oe_content += "<span class=\"label\">On Events</span><br/><br/>\n"
            ...
            if len(dynamics.regimes) > 0:
                for rg in dynamics.regimes:
                    ...
                    for eh in rg.event_handlers:
                        ...
                        if isinstance(eh, OnCondition):
                            if len(oc_content) == 0:
                                oc_content += spacer8 + "<span class=\"label\">On Conditions</span><br/><br/>\n"
